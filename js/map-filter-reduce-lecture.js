...
$(document).ready(function(){
    ...
    // Reduce Method
    // reduces all the values in an array to one primative value

    // array.reduce(function(previousVal, currentVal) {}, startingPoint)


    let grades = [92, 88, 76, 88, 70, 100];

    let total = grades.reduce((previousValue, currentValue) => previousValue + currentValue, 0);
    ...
    let sentenceArray = ["row", 'row', "row", "row", "your", "boat"];

    let combinedSentence = sentenceArray.reduce((previousValue, currentValue) => previousValue + currentValue, "Hey");
